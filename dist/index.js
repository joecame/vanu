(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.vanu = factory());
  ...
  function vanu() {
    ...
    return {
      ...
      handle(not, req) {
        ...
        if (unmount) { unmount(); unmount = void 0; }      let { pathname: path, search, hash: h } = req || w.location, i = 0;
        if (h) {
